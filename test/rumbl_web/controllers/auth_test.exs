defmodule RumbleWeb.AuthTest do
  ...
  test "login with a valid username amd pass", %{conn: conn} do
  ...
  test "login with a not found user", %{conn: conn} do
    ...
    {:error, :not_found, _conn} = Auth.login_by_email_and_pass(conn, "me@test", "secret")
  end  

  test "login with a password mismatch", %{conn: conn} do
    _ = user_fixture(username: "me", email: "me@test", password: "secret")

    {:error, :unauthorized, _conn} = Auth.login_by_email_and_pass(conn, "me@test", "wrong")
  end  
